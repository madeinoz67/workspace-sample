# com-chilipeppr-workspace-se1
Starting off Workspace for Stephen.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr seaton Workspace / Sample
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-se1 |
| Name                  | seaton Workspace / Sample |
| Description           | Starting off Workspace for Stephen. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/madeinoz67/workspace-sample/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/madeinoz67/cp-test |
| Github URL            | http://github.com/madeinoz67/workspace-sample |
| Test URL              | https://preview.c9users.io/madeinoz67/cp-test/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/madeinoz67/workspace-sample/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-se1"], // the id you gave your workspace
      function(myWorkspaceSe1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("seaton Workspace / Sample just got loaded.", myWorkspaceSe1);
        myWorkspaceSe1.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-se1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"seaton Workspace / Sample"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"Starting off Workspace for Stephen."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/madeinoz67/workspace-sample/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/madeinoz67/cp-test"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/madeinoz67/workspace-sample"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cp-test-madeinoz67.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
